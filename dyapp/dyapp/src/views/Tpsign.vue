  ...
  <div class="sign">
    ...
    <div class="sign-content">
      ...
      <div class="sign-box">
        ...
        <div class="inp">
          <input @keyup="loginAction1" v-model="phone"
          type="text" class="inp-controll" placeholder="请输入手机号">
        </div>
      </div>
      <div class="sign-box">
        <div class="inp">
          <input @keyup="loginAction2" v-model="password"
          type="password" class="inp-controll" placeholder="请输入密码">
        </div>
      </div>
      <div class="not-sign">
      ...
      <div class="code-btn">
        <button :disabled="disabled" :class="[btnBg?'active':'']">登录</button>
      </div>
      <div class="other">
