<template>
  <div class="sign">
    ...
    <div class="sign-content">
      <div class="des">
        <h2>登录后可展示自己</h2>
        <p>登录表明同意<a href="#">抖音协议</a>和<a href="#">隐私政策</a></p>
      </div>
      <div class="sign-box">
        <div class="sele">
        ...
        <div class="inp">
          <input v-model="phone" @input="changeTel" type="text"
          class="inp-controll" placeholder="请输入手机号">
        </div>
      </div>
      <div class="not-sign">
        <p>未注册手机号验证后将自动登录</p>
      ...
      <div class="other">
        <router-link tag="a" to="/tpsign" class="icon">密码登录</router-link>
